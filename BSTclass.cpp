...
int main()
{
    ...
    cout << "Enter nodes to insert into the BST (enter -1 to stop):" << endl;
    int data;
    while (true)
    {
        cin >> data;
    ...
    cout << "Enter a node to search in the BST:" << endl;
    cin >> data;
    cout << "Node " << data << " is present: " << b.search(data) << endl;

    cout << "Enter a node to remove from the BST:" << endl;
    cin >> data;
    b.remove(data);
